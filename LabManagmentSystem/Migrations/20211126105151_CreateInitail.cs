...
namespace LabManagmentSystem.Migrations
{
    public partial class CreateInitail : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Patient_Tables", x => x.Patient_Id);
                    table.ForeignKey(
                        name: "FK_Patient_Tables_Tests_TestId",
                        column: x => x.TestId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Patient_Tables_TestId",
                table: "Patient_Tables",
                column: "TestId");
        }
